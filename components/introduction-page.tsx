            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1 custom-scrollbar">
              {terms.map((term, index) => (
                <div key={index}>
                  ...
                  <p className="text-[11px] text-zinc-400 leading-relaxed">{term.text}</p>
                </div>
              ))}
            </div>
        ...
        <div className="flex items-center justify-center gap-3 mb-8 px-4">
          ...
          <div className="text-[10px] font-black leading-snug uppercase tracking-tight text-zinc-500">
            ...
            <button 
              ...
              className="text-[#f39c12] underline underline-offset-2 hover:text-white transition-colors mx-1 italic"
            >
              {content.agreeLink}
            </button>
            {content.agreeSuffix}
